...
int main() {
	...
	system ( "clang++ -std=c++11 -o a seg.cpp" );
	system ( "clang++ -std=c++11 -o p pro.cpp" );

	char pro[] = "./p > 001.in", pro2[] = "./a < 001.in > 001.out";
	for ( pro[7] = '0', pro2[7] = '0', pro2[16] = '0' ; pro[7] <= '3' ; pro[7]++, pro2[7]++, pro2[16]++ ) {
		for ( pro[8] = '0', pro2[8] = '0', pro2[17] = '0' ; pro[8] <= '9' ; pro[8]++, pro2[8]++, pro2[17]++ ) {
			cout << pro[7] << pro[8] << endl;
			cout << pro << endl << pro2 << endl;
			system ( pro );
			system ( pro2 );
		}
	}
